...
define(['./workbox-9ba2d447'], (function (workbox) { 'use strict';
  ...
  workbox.registerRoute(/^http:\/\/localhost:3001\/uploads\//, new workbox.CacheFirst({
  ...
  workbox.registerRoute(/^http:\/\/localhost:3001\/api\//, new workbox.NetworkFirst({
    "cacheName": "api-cache",
