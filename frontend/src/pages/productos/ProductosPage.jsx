    ...
    <Modal titulo={prod ? 'Editar Producto' : 'Nuevo Producto'} onClose={onClose} ancho="max-w-lg">
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <div>
            <label className="block text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wide mb-1.5">Costo (Bs)</label>
            <input
              type="number" min="0" step="0.01"
              value={form.costo}
          ...
          <div>
            <label className="block text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wide mb-1.5">Código interno</label>
            <input
              value={form.codigo}
